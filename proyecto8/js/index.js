let formulario = document.getElementById('formularioAgregar');
        let formularioEditar = document.getElementById('formularioEditarForm');
            ...
            tareas.forEach((tarea, indice) => {
                ...
                <div class='row'>
                    ...
                    <div class='col-4 border p-3 text-center'>
                        <img src="${ tarea.foto }" alt="Imagen" class="imagen-modificada" style="max-width: 100%;">
                    </div>
                    <div class='col-4 border p-3'>
                    ...
                    <div class='col-1 border p-3 text-center'>
                        <button class='btn btn-success' data-bs-toggle="modal" data-bs-target="#formularioEditar" onclick="editarTarea(${ indice })">Editar</button>
                    </div>
                    <div class='col-1 border p-3 text-center'>
        ...
        let editarTarea = (indice) => {
            ...
            cancionEditar.value = tareas[indice].audio;
        ...
        formularioEditar.addEventListener("submit", (e) => {
            ...
            tareas[indice].audio = cancionEditar.value;
            mostrarTareas();
            cerrarModalEditar();
        });
